...
complete plot including the Act 2 identity-swap twist and the killer's identity. Your job
is technical verification, not stylistic critique — the blind reviewer handles style.
...
- POV: Third-person limited, Theron only. Any Sable interiority on-page?
- Tense: Past tense throughout?
- System screens: Formatted as indented italic blocks, not HUD boxes?
- No Capitalised Worldbuilding Nouns not in the bible?

Report: Pass / Fail per item.

**3. Spoiler / foreshadowing discipline**
Does any line directly foreshadow the identity swap?
Does any character "almost catch" the swap (even implicitly)?
